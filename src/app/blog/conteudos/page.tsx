...
import { TrendingUp, ArrowRight, CreditCard, ArrowLeft } from "lucide-react";


export const metadata = {
  title: "Conteúdos — Manual do Brasileiro",
    ...
    <div className="min-h-screen bg-[var(--background)]">
      ...
      <div className="bg-[var(--brand-verde-escuro)] text-white pt-28 pb-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold">Conteúdos</h1>
