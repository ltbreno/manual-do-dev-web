...
import { businessAssessmentModules, calculateBusinessScore } from "@/data/business-assessment";
...
export default function EmpresasRaioXPage() {
    ...
    const isCurrentStepValid = () => {
        ...
        const module = businessAssessmentModules.find(m => m.id === currentStep.id);
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            alert(`Diagnóstico calculado com sucesso! Seu score final é ${scoreData.finalScore}. Nossa equipe entrará em contato.`);
            router.push("/raio-x");
        } catch (error) {
            console.error(error);
